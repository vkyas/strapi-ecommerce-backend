...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    id_products: Attribute.Relation<
      'api::order.order',
      'oneToMany',
      'api::product.product'
    >;
    ...
    status_order: Attribute.Enumeration<
      ['waiting_payment', 'success_payment', 'error_payment']
    >;
    discount: Attribute.Float;
    shopping_fee: Attribute.Float;
    voucher_data: Attribute.JSON;
    raja_ongkir: Attribute.JSON;
    berat_semua_barang: Attribute.Float;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    product_cover: Attribute.Media;
    product_release: Attribute.Date;
    product_stock: Attribute.Integer;
    product_weight: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiVoucherVoucher extends Schema.CollectionType {
  ...
  attributes: {
    code_voucher: Attribute.String & Attribute.Unique;
    potongan_persen: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
